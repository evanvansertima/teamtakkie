...
--  Onderaan dit bestand staan twee controles. De uitkomst moet zijn:
--
--    - een tabel met drie regels voor leden (lezen / toevoegen /
--      weghalen), waarbij in de kolom oordeel overal "in orde"
--      staat en nergens "STUK";
--    - de melding "OK: leden accepteert insert en delete".
--
...
--  je gegevens.
--
--  Je hoort onder "Messages" te lezen:
