...
const authConfig = defineConfig({
   ...
   * Session-based: the frontend and API share an origin behind the
   * Caddy reverse proxy, so a cookie session is simpler than managing
   * bearer tokens client-side for a single admin user.
   */
  default: 'web',
